...
export class CreateBusinessTables1690413718719 implements MigrationInterface {
  name = 'CreateBusinessTables1690413718719';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "business" ADD CONSTRAINT "FK_b9b47f8b0aa21535057e61a876f" FOREIGN KEY ("business_type_id") REFERENCES "business_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );

    await queryRunner.query(
      `ALTER TABLE "business_type" ADD CONSTRAINT "FK_01195157e47452ba23b35a9e355" FOREIGN KEY ("business_category_id") REFERENCES "business_category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "business_type" DROP CONSTRAINT "FK_01195157e47452ba23b35a9e355"`,
    );
    await queryRunner.query(
      `ALTER TABLE "business" DROP CONSTRAINT "FK_b9b47f8b0aa21535057e61a876f"`,
    );
